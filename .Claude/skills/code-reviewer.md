...
5. COHERENCE PROJET
   ...
   ## 6. Checklist spécifique FASO PAN

- [ ] defineProps assigné à const props = defineProps({})
- [ ] storeToRefs() utilisé (pas destructuring direct)
- [ ] watch avec immediate:true si pré-remplissage modal
- [ ] ->parameters() sur apiResource avec nom pluriel
- [ ] created_by assigné manuellement (pas via validated())
- [ ] DB::transaction() sur toute opération multi-tables
- [ ] face.statut vérifié avant toggleFace()
